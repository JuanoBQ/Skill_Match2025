      ...
      <div className="card shadow-lg border-0 rounded-4 mb-4" style={{ maxWidth: "100rem", margin: "auto" }}>
        ...
        <div className="container d-flex flex-row ms-5 mt-5">
          <div className="basic col-3">
            <p className="mb-2"><strong>Idiomas:</strong><br />{profile.language}</p>
            <p className="mb-2"><strong>Tarifa por hora:</strong><br />${profile.hourly_rate || "No definida"}</p>
            <p className="mb-2"><strong>Calificación:</strong><br />⭐ {profile.rating || "Sin calificación"}</p>
            <div className="mb-2">
