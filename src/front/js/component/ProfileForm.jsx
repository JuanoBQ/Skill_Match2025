...
const ProfileForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!bio || !hourlyRate || !profilePicture) {
        ...
        <div className="card-body p-4">
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <textarea className="form-control" value={bio} onChange={(e) => setBio(e.target.value)} rows="4" style={{ borderRadius: "10px" }} />
            </div>
            ...
            <div className="mb-3">
              ...
              <input type="text" className="form-control" value={profilePicture} onChange={(e) => setProfilePicture(e.target.value)} style={{ borderRadius: "10px" }} />
            </div>
