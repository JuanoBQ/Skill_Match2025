                        ...
                        <ul className="ms-2 col-7 row nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li className="card text-bg-secondary mb-3 col-5 ms-4 nav-item" role="presentation" style={{ height: "12.1rem" }}>
                                <div className="card-body p-0 ps-1 pt-2 mt-1 ms-1">
                                    ...
                                    <div className="d-flex">
                                        <p className="card-text fs-1 ms-1 mb-0">5</p><p className="card-text ms-1 mt-4">Usuarios</p>
                                    </div>
                                </div>
                                <button
                    ...
                    <div className="tab-content" id="pills-tabContent" style={{ marginTop: "1.8rem" }}>
                                        ...
                                        {list.map((project) => (
                                            <div key={project.id}>
                                                <div className="row">
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger mb-4 col-2" onClick={() => handleDelete(project.id)}><i class="fa-solid fa-trash fa-2xl"></i></button>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                        ...
                        >
                            ...
                            {/* <div className="d-flex">
                                ...
                                <div className="d-flex flex-column ms-3">
                                    <button type="button" className="btn btn-outline-danger pt-2" style={{ height: "3.2rem", marginBottom: "0.8rem" }}><i className="fa-solid fa-flag fa-2xl"></i></button>
                                    <button type="button" className="btn btn-outline-danger" style={{ height: "3.2rem" }}><i className="fa-solid fa-trash fa-2xl"></i></button>
                                </div>
                            </div>
                            <div className="d-flex">
                                <div className="card text-bg-secondary mb-4 col-10" style={{ width: "" }}>
                        ...
                        >
                            ...
                            <div className="row d-flex justify-content-center">
                                <div className="card text-bg-secondary ms-3 mb-4 col-9" style={{ width: "29rem" }}>
                                    <div className="card-body">
                                        <h5 className="card-title">Factura 2</h5>
                                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row d-flex justify-content-center">
                                <div className="card text-bg-secondary ms-3 mb-4 col-9" style={{ width: "29rem" }}>
                                    <div className="card-body">
                                        <h5 className="card-title">Factura 3</h5>
                                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row d-flex justify-content-center">
                                <div className="card text-bg-secondary ms-3 mb-4 col-9" style={{ width: "29rem" }}>
                                    <div className="card-body">
                                        <h5 className="card-title">Factura 4</h5>
                                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row d-flex justify-content-center">
                                <div className="card text-bg-secondary ms-3 mb-4 col-9" style={{ width: "29rem" }}>
                                    <div className="card-body">
                                        <h5 className="card-title">Factura 5</h5>
                                        <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card’s content.</p>
                                    </div>
                                </div>
                            </div>
